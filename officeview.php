        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                <div class="navbar-nav ml-auto">
                    ...
                    <a href="officeinsert.html" class="nav-item nav-link">Add Product</a>
...
<td>
           <div>
                        <a class="button button1" onclick="alert('Do you want to edit this Record..?')" href="officeedit.php?invoiceno=<?php echo $row['invoiceno']; ?>"><i class="fas fa-edit"></i> </a>
                        <a class="button button2" onclick="alert('Do you want to delete this Record..?')" href="officedelete.php?invoiceno=<?php echo $row['invoiceno'];?>"><i class="fas fa-trash-alt"></i></a>
                    </div>
</td>
        </tr>
