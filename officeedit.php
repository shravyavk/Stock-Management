...
<head>
    <meta charset="utf-8">
    <title>Updating Product Details</title>
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                <div class="navbar-nav ml-auto">
                    ...
                    <a href="officeview.php" class="nav-item nav-link">View Product</a>
                        </div>
                    </div>
...
Invoice Number: 
<input type="hidden" name="invoiceno" class="form-control" value="<?php echo $row['invoiceno']; ?>">
<input type="text" name="invoiceno" class="form-control"  value="<?php echo $row['invoiceno']; ?>">

<br>
Product Name : 
<input type="text" name="particulars" class="form-control" value="<?php echo $row['particulars']; ?>">
<br>
Quantity :
...
<br>
  ...
  <input class="btn custom-btn" onclick="alert('Record Updated Sucessfully..!')" type="submit" name="update" value="Update">
